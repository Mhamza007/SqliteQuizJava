package com.mhamza007.sqlitequizjava;
...
import com.mhamza007.sqlitequizjava.database.QuizDbHelper;
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNumber()) {
            case 1:
                ...
                textViewQuestion.setText("Option A is Correct Answer");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("Option B is Correct Answer");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("Option C is Correct Answer");
                break;
        }
